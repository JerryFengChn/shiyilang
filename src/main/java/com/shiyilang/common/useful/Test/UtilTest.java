...
import com.shiyilang.common.useful.EncryptionAlgorithm.MD5Encryption;
import com.shiyilang.common.useful.Mail.JavaSendMailForSSL;
/*
...
public class UtilTest{
	...
	//Logger.getLogger("UtilTest").log(Level.INFO,"123123123",new IOException());
   }
}
