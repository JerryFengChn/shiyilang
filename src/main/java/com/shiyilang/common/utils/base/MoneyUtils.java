...
/**
 * @Destription:Money Processing Tools
 * @Auther:shiyilang
...
public class MoneyUtils {
    ...
    /**
     * Number capitalization in Chinese
     */
     private static final String[] CN_UPPER_NUMBER = {"零","壹","贰","叁","肆","伍","陆","柒","捌","玖" };

     /**
      * Capital letters of monetary units in Chinese
      */
     ...
     /**
      * Accuracy of amount, default value is 2
      */
     private static final int MONEY_PRECISION = 2;

     /**
      * @Description:人民币转换为大写,格式为：x万x千x百x十x元x角x分
      * @Date 2018/11/29 22:22
      * @Param [numberOfMoney]
